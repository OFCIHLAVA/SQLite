...
for t in d_tables:
    print(t)
    print(sqllite.get_table_columns(database_path, t))

## Update specific record

# Show specific record

# Columns of table we are looking in
#tc = sqllite.get_table_columns(database_path, "boudyXprogramy")
#tc.insert(0, "ROWID")
#print(tc)

# What record to show
#record_criteria_columns = ['final monument']
#record_criteria = ["601539-501"]

# Show
#record = sqllite.get_specific_record(database_path, "boudyXprogramy", record_criteria_columns, record_criteria)
#print(record)

## Update specific record
#sqllite.update_record(database_path, "boudyXprogramy", "final monument", "601539-501", ["program"], ["BFE"])  

# Delete some table by name if needed
# sqllite.delete_table(database_path, "boudyXprogramy")
...
# sqllite.insert_many_records(database_path, 'boudyXprogramy', data)

# Create index on columns it table boudaXprogramy
# sqllite.create_index_on_column(database_path, "boudyXprogramy", "final monument")
